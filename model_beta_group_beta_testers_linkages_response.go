...
func (o *BetaGroupBetaTestersLinkagesResponse) UnmarshalJSON(bytes []byte) (err error) {
	varBetaGroupBetaTestersLinkagesResponse := _BetaGroupBetaTestersLinkagesResponse{}

	if err = json.Unmarshal(bytes, &varBetaGroupBetaTestersLinkagesResponse); err == nil {
