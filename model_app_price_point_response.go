...
type _AppPricePointResponse AppPricePointResponse
...
func (o *AppPricePointResponse) UnmarshalJSON(bytes []byte) (err error) {
	varAppPricePointResponse := _AppPricePointResponse{}

	if err = json.Unmarshal(bytes, &varAppPricePointResponse); err == nil {
		*o = AppPricePointResponse(varAppPricePointResponse)
	}
