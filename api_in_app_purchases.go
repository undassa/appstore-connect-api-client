...
func (r ApiInAppPurchasesGetInstanceRequest) Execute() (InAppPurchaseResponse, *_nethttp.Response, error) {
 ...
 */
func (a *InAppPurchasesApiService) InAppPurchasesGetInstance(ctx _context.Context, id string) ApiInAppPurchasesGetInstanceRequest {
	return ApiInAppPurchasesGetInstanceRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
 ...
 */
func (a *InAppPurchasesApiService) InAppPurchasesGetInstanceExecute(r ApiInAppPurchasesGetInstanceRequest) (InAppPurchaseResponse, *_nethttp.Response, error) {
	var (
