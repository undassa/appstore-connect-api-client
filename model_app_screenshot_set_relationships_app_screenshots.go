...
type _AppScreenshotSetRelationshipsAppScreenshots AppScreenshotSetRelationshipsAppScreenshots
...
// SetData gets a reference to the given []AppScreenshotSetRelationshipsAppScreenshotsData and assigns it to the Data field.
...
func (o *AppScreenshotSetRelationshipsAppScreenshots) UnmarshalJSON(bytes []byte) (err error) {
	varAppScreenshotSetRelationshipsAppScreenshots := _AppScreenshotSetRelationshipsAppScreenshots{}

	if err = json.Unmarshal(bytes, &varAppScreenshotSetRelationshipsAppScreenshots); err == nil {
		*o = AppScreenshotSetRelationshipsAppScreenshots(varAppScreenshotSetRelationshipsAppScreenshots)
	}
