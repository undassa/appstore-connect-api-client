...
type _AppRelationshipsInAppPurchases AppRelationshipsInAppPurchases
...
func (o *AppRelationshipsInAppPurchases) GetData() []AppRelationshipsInAppPurchasesData {
	if o == nil || o.Data == nil {
		var ret []AppRelationshipsInAppPurchasesData
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given []AppRelationshipsInAppPurchasesData and assigns it to the Data field.
...
func (o *AppRelationshipsInAppPurchases) UnmarshalJSON(bytes []byte) (err error) {
	varAppRelationshipsInAppPurchases := _AppRelationshipsInAppPurchases{}

	if err = json.Unmarshal(bytes, &varAppRelationshipsInAppPurchases); err == nil {
		*o = AppRelationshipsInAppPurchases(varAppRelationshipsInAppPurchases)
	}
