...
type _AppStoreVersionRelationshipsRoutingAppCoverage AppStoreVersionRelationshipsRoutingAppCoverage
...
func (o *AppStoreVersionRelationshipsRoutingAppCoverage) UnmarshalJSON(bytes []byte) (err error) {
	varAppStoreVersionRelationshipsRoutingAppCoverage := _AppStoreVersionRelationshipsRoutingAppCoverage{}

	if err = json.Unmarshal(bytes, &varAppStoreVersionRelationshipsRoutingAppCoverage); err == nil {
		*o = AppStoreVersionRelationshipsRoutingAppCoverage(varAppStoreVersionRelationshipsRoutingAppCoverage)
	}
