...
func (o *AppInfoLocalizationRelationshipsAppInfoData) UnmarshalJSON(bytes []byte) (err error) {
	varAppInfoLocalizationRelationshipsAppInfoData := _AppInfoLocalizationRelationshipsAppInfoData{}

	if err = json.Unmarshal(bytes, &varAppInfoLocalizationRelationshipsAppInfoData); err == nil {
