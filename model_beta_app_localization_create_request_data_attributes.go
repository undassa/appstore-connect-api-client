...
func (o *BetaAppLocalizationCreateRequestDataAttributes) UnmarshalJSON(bytes []byte) (err error) {
	varBetaAppLocalizationCreateRequestDataAttributes := _BetaAppLocalizationCreateRequestDataAttributes{}

	if err = json.Unmarshal(bytes, &varBetaAppLocalizationCreateRequestDataAttributes); err == nil {
