...
type _AppPricePointsResponse AppPricePointsResponse
...
func (o *AppPricePointsResponse) UnmarshalJSON(bytes []byte) (err error) {
	varAppPricePointsResponse := _AppPricePointsResponse{}

	if err = json.Unmarshal(bytes, &varAppPricePointsResponse); err == nil {
		*o = AppPricePointsResponse(varAppPricePointsResponse)
	}
