...
func (o *BuildRelationshipsBuildBetaDetailData) UnmarshalJSON(bytes []byte) (err error) {
	varBuildRelationshipsBuildBetaDetailData := _BuildRelationshipsBuildBetaDetailData{}

	if err = json.Unmarshal(bytes, &varBuildRelationshipsBuildBetaDetailData); err == nil {
