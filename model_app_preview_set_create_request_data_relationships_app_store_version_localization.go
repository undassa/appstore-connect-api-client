...
type _AppPreviewSetCreateRequestDataRelationshipsAppStoreVersionLocalization AppPreviewSetCreateRequestDataRelationshipsAppStoreVersionLocalization
...
func (o *AppPreviewSetCreateRequestDataRelationshipsAppStoreVersionLocalization) UnmarshalJSON(bytes []byte) (err error) {
	varAppPreviewSetCreateRequestDataRelationshipsAppStoreVersionLocalization := _AppPreviewSetCreateRequestDataRelationshipsAppStoreVersionLocalization{}

	if err = json.Unmarshal(bytes, &varAppPreviewSetCreateRequestDataRelationshipsAppStoreVersionLocalization); err == nil {
		*o = AppPreviewSetCreateRequestDataRelationshipsAppStoreVersionLocalization(varAppPreviewSetCreateRequestDataRelationshipsAppStoreVersionLocalization)
	}
